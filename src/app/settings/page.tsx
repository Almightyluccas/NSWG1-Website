...
export default async function SettingsPage() {
  ...
  const customHeroImages: CustomHeroImages[] = await database.get.userCustomHeroImages(session.user.id!)
  customHeroImages.forEach(image => {
    if (image.url && !image.url.startsWith("http") && process.env.OCI_BACKGROUND_PAR_URL) {
