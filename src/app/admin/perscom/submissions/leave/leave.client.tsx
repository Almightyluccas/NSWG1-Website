...
export const LeaveOfAbsenceTable = ({
  applications,
  ...
  const filteredApplications = applications.filter((app) => {
    ...
    const matchesSearch =
      firstName.includes(searchLower) || reasonForLeave.includes(searchLower);
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="max-w-xs truncate">
                        {application.reason_for_leave || "Not specified"}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                ...
                <div>
                  ...
                  <div className="mt-4">
                    ...
                    <div className="bg-gray-50 dark:bg-zinc-700/50 rounded-md p-4 space-y-4">
                      {(selectedApplication.date_of_leave ||
                        selectedApplication.date_of_return) && (
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-zinc-400">
                          {selectedApplication.reason_for_leave ||
                            "Not specified"}
                        </p>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-zinc-700/50 rounded-md p-4">
                    <ul className="space-y-2">
                      {selectedApplication.statuses &&
                        selectedApplication.statuses.map((status, index) => (
                      ...
                      {(!selectedApplication.statuses ||
                        selectedApplication.statuses.length === 0) && (
                        <li className="text-sm text-gray-500 dark:text-zinc-400">
                          No status updates
                        </li>
                      )}
                    </ul>
        ...
        <Dialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Are you sure you want to {actionToConfirm} this leave request
                for {applicationToConfirm?.first_name}?
              </DialogDescription>
            </DialogHeader>
            <DialogFooter>
              <DialogClose asChild>
