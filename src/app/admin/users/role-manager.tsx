...
export function RoleManager({
  ...
  const isCurrentUserSuperAdmin = currentUserRoles.includes(UserRole.superAdmin)
  ...
  const handleSubmit = async () => {
    ...
    if (!isCurrentUserDeveloper && !isCurrentUserSuperAdmin &&
      newRoles.includes(UserRole.superAdmin)) {
      toast.error("Only Developers and SuperAdmins can assign the SuperAdmin role")
      return
    }
