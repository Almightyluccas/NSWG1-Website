        ...
        <main className="min-h-screen bg-gray-50 dark:bg-zinc-900">
            ...
            <section className="relative pt-20">
                <div className="absolute inset-0 z-0">
                    ...
                    <Image src="/images/3-troops-walking-lil-bird.png" alt="About NSWG1" fill className="object-cover" />
                </div>
                ...
                <div className="container mx-auto px-4 z-10 relative py-20">
                    <FadeIn>
                        ...
                        <p className="text-xl text-gray-300 text-center max-w-2xl mx-auto">
                            Naval Special Warfare Group One: Elite tactical operations where precision, strategy, and unmatched
                            expertise converge.
                        </p>
                    </FadeIn>
                </div>
                        ...
                        <FadeIn>
                            <div>
                                ...
                                <p className="text-lg text-gray-700 dark:text-zinc-300 mb-6">
                                    Naval Special Warfare Group One (NSWG1) is dedicated to providing the most realistic and immersive
                                    military simulation experience possible. Our mission is to create an environment where tactics,
                                    teamwork, and precision are paramount.
                                </p>
                                <p className="text-lg text-gray-700 dark:text-zinc-300 mb-6">
                                    We strive to replicate the professionalism, discipline, and operational excellence of real-world
                                    special operations forces, while fostering a community of dedicated individuals who are passionate
                                    about military simulation.
                                </p>
                                <p className="text-lg text-gray-700 dark:text-zinc-300">
                                    Through rigorous training, authentic scenarios, and attention to detail, we aim to deliver an
                                    unparalleled tactical experience that challenges and develops each member&apos;s skills.
                                </p>
                            </div>
                        </FadeIn>
                        ...
                        <FadeIn delay={200}>
                            <div className="relative h-96 rounded-lg overflow-hidden shadow-xl">
                                ...
                                <div className="absolute bottom-0 left-0 p-6">
                                    ...
                                    <p className="text-gray-300">Developing the next generation of operators</p>
                                </div>
                            </div>
                        </FadeIn>
                    </div>
                ...
                <div className="container mx-auto px-4">
                    <FadeIn>
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-lg text-gray-700 dark:text-zinc-300">
                                At NSWG1, we uphold a set of core values that guide everything we do. These principles shape our
                                operations, training, and community.
                            </p>
                        </div>
                    </FadeIn>
                    ...
                    <FadeIn>
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-lg text-gray-700 dark:text-zinc-300 mb-8">
                                Before applying to join NSWG1, please ensure you meet the following requirements:
                            </p>
                        </div>
                    </FadeIn>
                ...
                <div className="container mx-auto px-4">
                    <FadeIn>
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <div className="h-1 w-24 bg-accent mx-auto mb-8"></div>
                            <p className="text-lg text-gray-700 dark:text-zinc-300">
                                NSWG1 is led by a team of experienced individuals dedicated to maintaining the highest standards of
                                tactical excellence.
                            </p>
                        </div>
                    </FadeIn>
    ...
    return (
        <FadeIn delay={delay}>
            <div className="bg-white dark:bg-zinc-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-zinc-700">
                <div className="bg-gray-100 dark:bg-zinc-700 p-3 rounded-lg inline-block mb-4">{icon}</div>
