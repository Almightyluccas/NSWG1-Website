          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <FadeIn delay={200}>
              ...
              <p className="text-lg text-zinc-300 max-w-2xl mx-auto">
                Task Force 160th, the elite aviation unit of Naval Special
                Warfare Group One, specializes in helicopter operations
                providing aviation support for special operations forces. With
                unmatched precision and skill, our pilots execute the most
                challenging missions in any environment, day or night.
              </p>
            </FadeIn>
          </div>
        </div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <AccordionSection
                  ...
                  content={
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Must have experience with helicopter flight in Arma 3.
                      </li>
                      <li>
                ...
                <AccordionSection
                  ...
                  content={
                    <>
                      <ul className="list-disc pl-5 space-y-2">
                        <li>
                          Providing aviation support for special operations
                          missions.
                        </li>
                        <li>
                          Conducting insertions and extractions of special
                          operations forces.
                        </li>
                        <li>
                          Executing precision strikes and close air support.
                        </li>
                        <li>
                ...
                <AccordionSection
                  ...
                  content={
                    <p>
                      As a member of Task Force 160th, you&apos;ll be part of an
                      elite aviation unit that operates in the most challenging
                      environments. You&apos;ll receive specialized training in
                      night operations, low-level flight, and special operations
                      support. You&apos;ll work closely with other special
                      operations units to execute complex missions requiring
                      precision and skill.
                    </p>
                  }
                  delay={200}
      ...
      <footer className="bg-zinc-900 border-t border-zinc-800 py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap gap-4 md:gap-8">
              ...
              <div className="flex flex-col">
                ...
                <a
                  href="/tf160th"
                  className="text-zinc-500 hover:text-accent transition-colors text-sm mb-1"
                >
                  Task Force 160th
                </a>
                <a
          ...
          <div className="border-t border-zinc-800 mt-8 pt-8 text-center text-zinc-500 text-sm">
            © {new Date().getFullYear()} Naval Special Warfare Group One. All
            rights reserved.
          </div>
        </div>
      </footer>
