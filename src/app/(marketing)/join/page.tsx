...
import JoinFormClient from "@/app/(marketing)/join/join-form.client";
    ...
    <main className="min-h-screen bg-gray-50 dark:bg-zinc-900">
      ...
      <section className="relative pt-20">
        <div className="absolute inset-0 z-0">
          ...
          <Image
            src="/images/join-background.png"
            alt="Join NSWG1"
            fill
        ...
        <div className="container mx-auto px-4 z-10 relative py-20">
          <FadeIn>
            ...
            <p className="text-xl text-gray-300 text-center max-w-2xl mx-auto">
              Apply to become part of our elite tactical team. Complete the form
