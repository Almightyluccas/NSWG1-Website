                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-center space-x-2 pb-2">
                    <input
                      ...
                      className="h-4 w-4 rounded border-gray-300 text-[#5865F2] focus:ring-[#5865F2] dark:border-zinc-600 dark:bg-zinc-700 dark:ring-offset-zinc-800 cursor-pointer"
                    />
                    <label
                      htmlFor="remember-me"
