            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                <div className="relative mb-4">
                  ...
                  <div className="absolute -bottom-2 -right-2 rounded-full border-2 border-accent bg-background p-1">
                    <Image
                ...
                <p className="mb-2 text-gray-500 dark:text-zinc-400">
                  {user.rank?.name || "Unknown"}
                </p>
                      ...
                      <div key={index} className="text-center">
                        <div className="group relative">
                          <Image
                            ...
                            alt="Award"
                            className="h-20 w-20 cursor-pointer object-contain transition-transform group-hover:scale-110"
                            width={80}
                            height={80}
                            onClick={() => openAwardModal(record)}
                          />
                          <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-black bg-opacity-75 px-2 py-1 text-xs text-white opacity-0 transition-opacity group-hover:opacity-100">
                            {awardImage?.name}
                          </div>
                        </div>
                      </div>
