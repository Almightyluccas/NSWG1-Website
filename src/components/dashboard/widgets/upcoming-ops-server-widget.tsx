import { getMissionsByDateRange, getTrainingByDateRange } from "@/app/dashboard/calendar/action";
import { format, addDays } from "date-fns";
import { UpcomingOpsWidget } from "./upcoming-ops-widget";

export default async function UpcomingOpsServerWidget({ currentUserId }: { currentUserId: string }) {
  ...
  return <UpcomingOpsWidget upcomingOps={allUpcoming} currentUserId={currentUserId} />;
}
