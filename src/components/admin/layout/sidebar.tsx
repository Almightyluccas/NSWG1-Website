            ...
            >
              ...
              <ChevronDown
                className={cn(
                  ...
                  perscomOpen ? "transform rotate-180" : ""
                )}
              />
            </div>
                ...
                <li>
                  ...
                  >
                    ...
                    <ChevronDown
                      className={cn(
                        "h-4 w-4 transition-transform",
                        submissionsOpen ? "transform rotate-180" : ""
                      )}
                    />
                  </div>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <ChevronDown
                        className={cn(
                          "h-4 w-4 transition-transform",
                          organizationOpen ? "transform rotate-180" : ""
                        )}
                      />
                    </div>
                        ...
                        <li>
                          <Link
                            ...
                            className={cn(
                              "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors",
                              pathname ===
                                "/admin/perscom/organization/positions"
                                ? "bg-accent text-black"
                                : "text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-700"
                            )}
                          >
                        ...
                        <li>
                          <Link
                            ...
                            className={cn(
                              "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors",
                              pathname ===
                                "/admin/perscom/organization/specialties"
                                ? "bg-accent text-black"
                                : "text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-700"
                            )}
                          >
                        ...
                        <li>
                          <Link
                            ...
                            className={cn(
                              "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors",
                              pathname ===
                                "/admin/perscom/organization/statuses"
                                ? "bg-accent text-black"
                                : "text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-700"
                            )}
                          >
                        ...
                        <li>
                          <Link
                            ...
                            className={cn(
                              "flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors",
                              pathname ===
                                "/admin/perscom/organization/qualifications"
                                ? "bg-accent text-black"
                                : "text-gray-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-700"
                            )}
                          >
